from crypto.crypto_utils import mix_matrices, string_to_packets, SubsBoxes, mix_columns, shift_rows, create_packets, \
    packet_to_bytes
...
class MyHash:
    ...
    def hash(self, _bytes, iterations=5):
        return packet_to_bytes(self.hash_packs(create_packets(_bytes), iterations))
